...
export const HowItWorksSection = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col w-fulll items-start gap-[50px]">
      <div className="container">
        ...
        <header className="flex flex-col items-start mb-8">
          ...
          <p className="gap-[20px] font-sub-heading text-text text-[length:var(--sub-heading-font-size)] font-[number:var(--sub-heading-font-weight)] tracking-[var(--sub-heading-letter-spacing)] leading-[var(--sub-heading-line-height)] [font-style:var(--sub-heading-font-style)]">
                  ...
                  >
                    <div className="flex flex-col w-[290px] items-start gap-[39px] pt-11 pl-[27px]">
                      <div className="inline-flex items-start gap-2.5 rounded-[5px]">
                        <span className="[color:linear-gradient(132deg,rgba(255,152,152,1)_0%,rgba(153,24,196,0.53)_100%)]  bg-clip-text [-webkit-text-fill-color:transparentt]  [font-family:'Poppins',Helvetica] font-bold italic text-transparent text-[32px] leading-5"
                          style={{ color: 'linear-gradient(92.51deg, #FF9898 0.48%, rgba(153, 24, 196, 0.533333) 100%)' }}
                        >
                          {step.number}
                        </span>
                      </div>
